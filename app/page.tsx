          ...
          <main className="flex-1 flex flex-col max-w-[480px]">
            ...
            <section style={{ padding: "24px 0 24px" }}>
              ...
              >
                ...
                <span style={{ color: "var(--accent-secondary)" }}>{hero.launchBadgeCity}</span>{" "}
              ...
              >
                <span className="text-white whitespace-pre-line">{hero.headlineWhite}</span>
                <br />
                <span style={{ color: "var(--accent-secondary)" }}>{hero.headlineAccent}</span>
              </h1>
            ...
            {/* Below the fold */}
            <div>
              <div style={{ borderTop: "0.5px solid rgba(255,255,255,0.05)", margin: "32px 0" }} />
              <FeatureCards />
