  ...
  cards: [
    {
      ...
      title: "Real-time venue signals",
      description: `Not reviews from 3 weeks ago. Live energy data — what's packed, what's dead, what's peaking right now.`,
    },
    {
      icon: "neighborhood" as const,
      title: "Neighborhood-level intel",
      description: `South End vs Plaza Midwood vs Uptown — know which pocket of the city is going off before you leave home.`,
    },
    {
      icon: "alert" as const,
      title: "Friday alerts, not newsletters",
      description: `One push at 9pm on weekends. Where to go tonight, based on what's actually happening — not sponsored content.`,
    },
  ],
};
